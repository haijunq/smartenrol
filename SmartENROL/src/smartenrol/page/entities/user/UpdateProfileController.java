...
public class UpdateProfileController extends SmartEnrolController {
    ...
    @FXML private TextField line1TextBox, line2TextBox, line3TextBox, line5TextBox, line10TextBox, 
                            line6TextBox, line7TextBox, line8TextBox, line9TextBox, line11TextBox, username;
    
    @FXML private ComboBox line4ComboBox, line8ComboBox;
    
    @FXML private Text errorText, lastUpdated, lastModifiedBy, dateCreated, line1, line2, line3, line4, line5, line6, line7, line8, line9, line10, line11;
    ...
    public void load(int idUser) {
            ...
            lastUpdated.setText(thisUser.getLastModified().toString());
            dateCreated.setText(thisUser.getDateCreated().toString());
            lastModifiedBy.setText(lastModBy.getFullName());
    ...
    public void setAllLinesToBlack() {
