...
public class DepartmentService {
    ...
    private void updateDepartmentFromUserInput(final Department department) {
        ...
        building.setIdLocation(userInputValueHolder.get(IDepartmentServiceConstants.ID_LOCATION));
        department.setIdLocation(building);

        Faculty faculty = new Faculty();
        faculty.setIdFaculty(userInputValueHolder.get(IDepartmentServiceConstants.ID_FACULTY));
        department.setIdFaculty(faculty);
